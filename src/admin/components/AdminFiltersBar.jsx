...
export function AdminFiltersBar({ intro }) {
  ...
  return (
    <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <h2 className="text-base font-semibold text-slate-900">Saring tampilan data</h2>
      {intro ? (
      ...
      <div className="mt-4 flex flex-wrap items-end gap-3">
        <label className="text-xs font-medium text-slate-700" htmlFor="admin-filter-learning-path">
          ...
          <select
            ...
            className="mt-1 block min-w-[14rem] max-w-[20rem] rounded-lg border border-slate-300 bg-white px-2 py-1.5 text-sm text-slate-900"
          >
        ...
        <label className="text-xs font-medium text-slate-700" htmlFor="admin-filter-lang">
          Bahasa (kode singkat)
          <input
            ...
            className="mt-1 block w-36 rounded-lg border border-slate-300 px-2 py-1.5 text-sm text-slate-900"
          />
        </label>
        <label className="text-xs font-medium text-slate-700" htmlFor="admin-filter-publish">
          ...
          <select
            ...
            className="mt-1 block rounded-lg border border-slate-300 bg-white px-2 py-1.5 text-sm text-slate-900"
          >
        ...
        <button
          ...
          disabled={loading}
          onClick={() => {
            const empty = { category: '', language_code: '', is_published: '' };
